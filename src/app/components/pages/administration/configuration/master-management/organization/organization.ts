...
import { MasterManagementOrganizationItem, MasterManagementOrganizationRow } from './organization.model';
import { MasterManagementOrganizationService } from './organization.service';

interface MasterManagementOrganizationColumn {
  key: string;
  label: string;
  visible: boolean;
}
...
@Component({
  standalone: true,
  selector: 'app-master-management-organization',
  imports: [CommonModule, FormsModule, ImportFileModal, RowActions],
  templateUrl: './organization.html',
  styleUrls: ['./organization.css']
})
export class MasterManagementOrganization {
  searchTerm = '';

  columns: MasterManagementOrganizationColumn[] = [
  ...
  records: MasterManagementOrganizationRow[] = [];
  filteredRecords: MasterManagementOrganizationRow[] = [];

  showFormModal = false;
  isEditMode = false;
  private editingRecord: MasterManagementOrganizationRow | null = null;

  form: MasterManagementOrganizationItem = this.emptyForm();

  private returnUrl: string | null = null;

  constructor(
    private service: MasterManagementOrganizationService,
  ...
  private emptyForm(): MasterManagementOrganizationItem {
    return {
      organizationCode: '',
      assetId: '',
      assetName: '',
  ...
  toggleColumn(col: MasterManagementOrganizationColumn): void {
    col.visible = !col.visible;
  }

  get selectedRecords(): MasterManagementOrganizationRow[] {
  ...
  toggleSelectRecord(record: MasterManagementOrganizationRow): void {
    record.selected = !record.selected;
  }

  onSearch(): void {
    this.filteredRecords = this.service.search(this.searchTerm) as MasterManagementOrganizationRow[];
  }
  ...
  editRow(record: MasterManagementOrganizationRow): void {
    this.isEditMode = true;
  ...
  deleteRow(record: MasterManagementOrganizationRow): void {
